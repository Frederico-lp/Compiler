...
public interface SymbolTable {
     ...
     * @param methodSignature
     * @param identifier
     * @return true if the identifier is a local variable in a given method
     */
    boolean isLocalVariable(String methodSignature, String identifier);

    /**
     *
     * @param methodSignature
     * @param identifier
     * @return true if the identifier is a parameter in a given method
     */
    boolean isParameter(String methodSignature, String identifier);

    /**
     *
     * @param identifier
     * @return true if the identifier is a field of the class
     */
    boolean isField(String identifier);

    /**
     * @param identifier
     * @return true if the identifier is an import
     */
    boolean isImport(String identifier);
